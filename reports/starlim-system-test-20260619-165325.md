...
- Fecha y hora: 2026-06-19T16:54:06.577796
...
| DB-0130 | database | connectivity | `Supabase` | SELECT 1 | PASS | 1 | 1 | 197ms | select 1 |
| DB-0131 | database | schema | `usuarios` | expected table exists | PASS | table exists | 1 | 592ms | information_schema.tables |
| DB-0132 | database | schema | `empresas` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0133 | database | schema | `usuario_empresa` | expected table exists | PASS | table exists | 1 | 595ms | information_schema.tables |
| DB-0134 | database | schema | `app_roles` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0135 | database | schema | `app_permisos` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0136 | database | schema | `app_usuario_roles` | expected table exists | PASS | table exists | 1 | 594ms | information_schema.tables |
| DB-0137 | database | schema | `app_usuario_permisos` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0138 | database | schema | `secuencias_empresa` | expected table exists | PASS | table exists | 1 | 588ms | information_schema.tables |
| DB-0139 | database | schema | `ventas` | expected table exists | PASS | table exists | 1 | 593ms | information_schema.tables |
| DB-0140 | database | schema | `detalle_ventas` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0141 | database | schema | `presupuestos` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0142 | database | schema | `remitos` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0143 | database | schema | `detalle_remitos` | expected table exists | PASS | table exists | 1 | 588ms | information_schema.tables |
| DB-0144 | database | schema | `repartos` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0145 | database | schema | `reparto_pedidos` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0146 | database | schema | `clientes` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0147 | database | schema | `proveedores` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0148 | database | schema | `customer_fiscal_profile` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0149 | database | schema | `productos` | expected table exists | PASS | table exists | 1 | 594ms | information_schema.tables |
| DB-0150 | database | schema | `rubros` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0151 | database | schema | `margenes` | expected table exists | PASS | table exists | 1 | 588ms | information_schema.tables |
| DB-0152 | database | schema | `listas_precio` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0153 | database | schema | `margenes_listas` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0154 | database | schema | `compras_registro` | expected table exists | PASS | table exists | 1 | 592ms | information_schema.tables |
| DB-0155 | database | schema | `detalle_compras_registro` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0156 | database | schema | `stock_modificaciones` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0157 | database | schema | `pagos_registro` | expected table exists | PASS | table exists | 1 | 592ms | information_schema.tables |
| DB-0158 | database | schema | `cuentas_corrientes` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0159 | database | schema | `billing_document` | expected table exists | PASS | table exists | 1 | 595ms | information_schema.tables |
| DB-0160 | database | schema | `billing_document_line` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0161 | database | schema | `billing_tax_line` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0162 | database | schema | `fiscal_authorization` | expected table exists | PASS | table exists | 1 | 596ms | information_schema.tables |
| DB-0163 | database | schema | `billing_payment_allocation` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0164 | database | schema | `billing_event` | expected table exists | PASS | table exists | 1 | 588ms | information_schema.tables |
| DB-0165 | database | schema | `billing_audit_log` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0166 | database | schema | `fiscal_sync_job` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0167 | database | schema | `admin_resources` | expected table exists | PASS | table exists | 1 | 588ms | information_schema.tables |
| DB-0168 | database | schema | `admin_audit_log` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0169 | database | schema | `admin_socios` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0170 | database | schema | `admin_dividendos` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0171 | database | schema | `admin_sueldos_config` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0172 | database | schema | `admin_sueldo_movimientos` | expected table exists | PASS | table exists | 1 | 594ms | information_schema.tables |
| DB-0173 | database | schema | `admin_obligaciones_fiscales` | expected table exists | PASS | table exists | 1 | 590ms | information_schema.tables |
| DB-0174 | database | schema | `admin_bank_accounts` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0175 | database | schema | `admin_bank_statement_lines` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0176 | database | schema | `admin_bank_reconciliation_matches` | expected table exists | PASS | table exists | 1 | 591ms | information_schema.tables |
| DB-0177 | database | schema | `eventos_integracion` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| DB-0178 | database | schema | `ventas_modificaciones` | expected table exists | PASS | table exists | 1 | 589ms | information_schema.tables |
| PERM-0179 | database | permissions | `admin.panel` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0180 | database | permissions | `admin.tesoreria` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0181 | database | permissions | `admin.conciliacion_bancaria` | admin resource exists | PASS | 1 active resource | 1 | 590ms | admin_resources |
| PERM-0182 | database | permissions | `admin.metricas` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0183 | database | permissions | `admin.movimientos` | admin resource exists | PASS | 1 active resource | 1 | 591ms | admin_resources |
| PERM-0184 | database | permissions | `admin.cashflow` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0185 | database | permissions | `admin.balance` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0186 | database | permissions | `admin.dividendos` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0187 | database | permissions | `admin.sueldos` | admin resource exists | PASS | 1 active resource | 1 | 588ms | admin_resources |
| PERM-0188 | database | permissions | `admin.calendario` | admin resource exists | PASS | 1 active resource | 1 | 594ms | admin_resources |
| PERM-0189 | database | permissions | `admin.usuarios` | admin resource exists | PASS | 1 active resource | 1 | 591ms | admin_resources |
| PERM-0190 | database | permissions | `admin.obligaciones_fiscales` | admin resource exists | PASS | 1 active resource | 1 | 589ms | admin_resources |
| PERM-0191 | database | permissions | `admin.resultados` | admin resource exists | PASS | 1 active resource | 1 | 594ms | admin_resources |
| PERM-0192 | database | permissions | `admin.cuentas_por_pagar` | admin resource exists | PASS | 1 active resource | 1 | 591ms | admin_resources |
...
| PROD-0196 | production-readonly | http | `/` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=308; location=/frontend/index.php; php_error=False | 160ms | https://star-lim-phi.vercel.app/ |
| PROD-0197 | production-readonly | http | `/frontend/index.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=200; location=; php_error=False | 443ms | https://star-lim-phi.vercel.app/frontend/index.php |
| PROD-0198 | production-readonly | http | `/frontend/sign.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=200; location=; php_error=False | 319ms | https://star-lim-phi.vercel.app/frontend/sign.php |
| PROD-0199 | production-readonly | http | `/frontend/panel_empleados.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=302; location=sign.php?expired=1; php_error=False | 298ms | https://star-lim-phi.vercel.app/frontend/panel_empleados.php |
| PROD-0200 | production-readonly | http | `/frontend/admin_conciliacion_bancaria.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=302; location=sign.php?expired=1; php_error=False | 294ms | https://star-lim-phi.vercel.app/frontend/admin_conciliacion_bancaria.php |
...
Rutas cubiertas: 10.42%
Endpoints cubiertos: 0.0%
Reporte: reports/starlim-system-test-20260619-165325.md
========================================
```
