...
- Fecha y hora: 2026-06-20T19:38:23.508149
...
| STATIC-0118 | static | includes | `api/php/registro_usuario_be.php` | include conexion_starlim_be.php | PASS | Include target resolvable or dynamic documented | exists | 0ms | api/php/registro_usuario_be.php |
| STATIC-0119 | static | includes | `api/php/stock_upload_be.php` | include conexion_starlim_be.php | PASS | Include target resolvable or dynamic documented | exists | 0ms | api/php/stock_upload_be.php |
| STATIC-0120 | static | includes | `api/php/ver_presupuesto_pdf.php` | include conexion_starlim_be.php | PASS | Include target resolvable or dynamic documented | exists | 0ms | api/php/ver_presupuesto_pdf.php |
| STATIC-0121 | static | includes | `api/php/ver_presupuesto_pdf.php` | include presupuesto_pdf_lib.php | PASS | Include target resolvable or dynamic documented | exists | 0ms | api/php/ver_presupuesto_pdf.php |
| STATIC-0122 | static | includes | `api/phpqrcode/index.php` | include qrlib.php | PASS | Include target resolvable or dynamic documented | exists | 0ms | api/phpqrcode/index.php |
| SEC-0123 | static | secrets | `repository` | secret pattern scan | WARNING | No obvious secrets committed | 5 files flagged: ['.env.example', '.env.smoke.example', 'api/facturacion/src/afip.php-master/src/Afip.php', 'api/php/storage_supabase.php', 'reports/starlim-inventory.json'] | 0ms | rg-like scan |
| DB-0124 | database | connectivity | `Supabase` | SELECT 1 | PASS | 1 | 1 | 186ms | select 1 |
| DB-0125 | database | schema | `usuarios` | expected table exists | PASS | table exists | 1 | 565ms | information_schema.tables |
| DB-0126 | database | schema | `empresas` | expected table exists | PASS | table exists | 1 | 563ms | information_schema.tables |
| DB-0127 | database | schema | `usuario_empresa` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0128 | database | schema | `app_roles` | expected table exists | PASS | table exists | 1 | 564ms | information_schema.tables |
| DB-0129 | database | schema | `app_permisos` | expected table exists | PASS | table exists | 1 | 563ms | information_schema.tables |
| DB-0130 | database | schema | `app_usuario_roles` | expected table exists | PASS | table exists | 1 | 564ms | information_schema.tables |
| DB-0131 | database | schema | `app_usuario_permisos` | expected table exists | PASS | table exists | 1 | 572ms | information_schema.tables |
| DB-0132 | database | schema | `secuencias_empresa` | expected table exists | PASS | table exists | 1 | 559ms | information_schema.tables |
| DB-0133 | database | schema | `ventas` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0134 | database | schema | `detalle_ventas` | expected table exists | PASS | table exists | 1 | 563ms | information_schema.tables |
| DB-0135 | database | schema | `presupuestos` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0136 | database | schema | `remitos` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0137 | database | schema | `detalle_remitos` | expected table exists | PASS | table exists | 1 | 562ms | information_schema.tables |
| DB-0138 | database | schema | `repartos` | expected table exists | PASS | table exists | 1 | 564ms | information_schema.tables |
| DB-0139 | database | schema | `reparto_pedidos` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0140 | database | schema | `clientes` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0141 | database | schema | `proveedores` | expected table exists | PASS | table exists | 1 | 565ms | information_schema.tables |
| DB-0142 | database | schema | `customer_fiscal_profile` | expected table exists | PASS | table exists | 1 | 571ms | information_schema.tables |
| DB-0143 | database | schema | `productos` | expected table exists | PASS | table exists | 1 | 571ms | information_schema.tables |
| DB-0144 | database | schema | `rubros` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0145 | database | schema | `margenes` | expected table exists | PASS | table exists | 1 | 566ms | information_schema.tables |
| DB-0146 | database | schema | `listas_precio` | expected table exists | PASS | table exists | 1 | 565ms | information_schema.tables |
| DB-0147 | database | schema | `margenes_listas` | expected table exists | PASS | table exists | 1 | 562ms | information_schema.tables |
| DB-0148 | database | schema | `compras_registro` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0149 | database | schema | `detalle_compras_registro` | expected table exists | PASS | table exists | 1 | 562ms | information_schema.tables |
| DB-0150 | database | schema | `stock_modificaciones` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0151 | database | schema | `pagos_registro` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0152 | database | schema | `cuentas_corrientes` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0153 | database | schema | `billing_document` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0154 | database | schema | `billing_document_line` | expected table exists | PASS | table exists | 1 | 564ms | information_schema.tables |
| DB-0155 | database | schema | `billing_tax_line` | expected table exists | PASS | table exists | 1 | 559ms | information_schema.tables |
| DB-0156 | database | schema | `fiscal_authorization` | expected table exists | PASS | table exists | 1 | 564ms | information_schema.tables |
| DB-0157 | database | schema | `billing_payment_allocation` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0158 | database | schema | `billing_event` | expected table exists | PASS | table exists | 1 | 630ms | information_schema.tables |
| DB-0159 | database | schema | `billing_audit_log` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0160 | database | schema | `fiscal_sync_job` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0161 | database | schema | `admin_resources` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0162 | database | schema | `admin_audit_log` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0163 | database | schema | `admin_socios` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0164 | database | schema | `admin_dividendos` | expected table exists | PASS | table exists | 1 | 562ms | information_schema.tables |
| DB-0165 | database | schema | `admin_sueldos_config` | expected table exists | PASS | table exists | 1 | 565ms | information_schema.tables |
| DB-0166 | database | schema | `admin_sueldo_movimientos` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0167 | database | schema | `admin_obligaciones_fiscales` | expected table exists | PASS | table exists | 1 | 565ms | information_schema.tables |
| DB-0168 | database | schema | `admin_bank_accounts` | expected table exists | PASS | table exists | 1 | 562ms | information_schema.tables |
| DB-0169 | database | schema | `admin_bank_statement_lines` | expected table exists | PASS | table exists | 1 | 560ms | information_schema.tables |
| DB-0170 | database | schema | `admin_bank_reconciliation_matches` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0171 | database | schema | `eventos_integracion` | expected table exists | PASS | table exists | 1 | 561ms | information_schema.tables |
| DB-0172 | database | schema | `ventas_modificaciones` | expected table exists | PASS | table exists | 1 | 562ms | information_schema.tables |
| PERM-0173 | database | permissions | `admin.panel` | admin resource exists | PASS | 1 active resource | 1 | 562ms | admin_resources |
| PERM-0174 | database | permissions | `admin.tesoreria` | admin resource exists | PASS | 1 active resource | 1 | 559ms | admin_resources |
| PERM-0175 | database | permissions | `admin.conciliacion_bancaria` | admin resource exists | PASS | 1 active resource | 1 | 561ms | admin_resources |
| PERM-0176 | database | permissions | `admin.metricas` | admin resource exists | PASS | 1 active resource | 1 | 560ms | admin_resources |
| PERM-0177 | database | permissions | `admin.movimientos` | admin resource exists | PASS | 1 active resource | 1 | 560ms | admin_resources |
| PERM-0178 | database | permissions | `admin.cashflow` | admin resource exists | PASS | 1 active resource | 1 | 558ms | admin_resources |
| PERM-0179 | database | permissions | `admin.balance` | admin resource exists | PASS | 1 active resource | 1 | 558ms | admin_resources |
| PERM-0180 | database | permissions | `admin.dividendos` | admin resource exists | PASS | 1 active resource | 1 | 561ms | admin_resources |
| PERM-0181 | database | permissions | `admin.sueldos` | admin resource exists | PASS | 1 active resource | 1 | 559ms | admin_resources |
| PERM-0182 | database | permissions | `admin.calendario` | admin resource exists | PASS | 1 active resource | 1 | 562ms | admin_resources |
| PERM-0183 | database | permissions | `admin.usuarios` | admin resource exists | PASS | 1 active resource | 1 | 562ms | admin_resources |
| PERM-0184 | database | permissions | `admin.obligaciones_fiscales` | admin resource exists | PASS | 1 active resource | 1 | 560ms | admin_resources |
| PERM-0185 | database | permissions | `admin.resultados` | admin resource exists | PASS | 1 active resource | 1 | 561ms | admin_resources |
| PERM-0186 | database | permissions | `admin.cuentas_por_pagar` | admin resource exists | PASS | 1 active resource | 1 | 561ms | admin_resources |
| PERM-0187 | database | permissions | `Admin` | Admin inherits all admin permissions | PASS | 36 | 36 | 0ms | app_rol_permisos |
| PERM-0188 | database | permissions | `non-Admin roles` | Non-admin roles do not inherit admin by default | PASS | 0 | 0 | 0ms | app_rol_permisos |
| TENANT-0189 | database | multiempresa | `business tables` | empresa_id coverage | PASS | all key tables have empresa_id | all present | 0ms | information_schema.columns |
| PROD-0190 | production-readonly | http | `/` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=308; location=/frontend/index.php; php_error=False | 163ms | https://star-lim-phi.vercel.app/ |
| PROD-0191 | production-readonly | http | `/frontend/index.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=200; location=; php_error=False | 464ms | https://star-lim-phi.vercel.app/frontend/index.php |
| PROD-0192 | production-readonly | http | `/frontend/sign.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=200; location=; php_error=False | 298ms | https://star-lim-phi.vercel.app/frontend/sign.php |
| PROD-0193 | production-readonly | http | `/frontend/panel_empleados.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=302; location=sign.php?expired=1; php_error=False | 409ms | https://star-lim-phi.vercel.app/frontend/panel_empleados.php |
| PROD-0194 | production-readonly | http | `/frontend/admin_conciliacion_bancaria.php` | GET route smoke | PASS | 200/308 for public, 302/401/403 for protected | status=302; location=sign.php?expired=1; php_error=False | 360ms | https://star-lim-phi.vercel.app/frontend/admin_conciliacion_bancaria.php |
| PROD-0195 | production-readonly | tls | `star-lim-phi.vercel.app` | TLS certificate | PASS | valid certificate returned | Jul 27 02:04:42 2026 GMT | 0ms | ssl |
| E2E-0196 | e2e/business | safe-write-flows | `Admin login E2E` | safe write flow gate | BLOCKED | Safe test/staging credentials and writable test tenant | No non-production writable environment or test credentials were provided; production is read-only by prompt. | 0ms | safety gate |
| E2E-0197 | e2e/business | safe-write-flows | `Limited user E2E` | safe write flow gate | BLOCKED | Safe test/staging credentials and writable test tenant | No non-production writable environment or test credentials were provided; production is read-only by prompt. | 0ms | safety gate |
| E2E-0198 | e2e/business | safe-write-flows | `Cliente-presupuesto-venta-entrega-cobro` | safe write flow gate | BLOCKED | Safe test/staging credentials and writable test tenant | No non-production writable environment or test credentials were provided; production is read-only by prompt. | 0ms | safety gate |
| E2E-0199 | e2e/business | safe-write-flows | `Compra-stock-pago` | safe write flow gate | BLOCKED | Safe test/staging credentials and writable test tenant | No non-production writable environment or test credentials were provided; production is read-only by prompt. | 0ms | safety gate |
| E2E-0200 | e2e/business | safe-write-flows | `Conciliacion bancaria write flow` | safe write flow gate | BLOCKED | Safe test/staging credentials and writable test tenant | No non-production writable environment or test credentials were provided; production is read-only by prompt. | 0ms | safety gate |
| E2E-0201 | e2e/business | safe-write-flows | `Facturacion fiscal authorization` | safe write flow gate | BLOCKED | Safe test/staging credentials and writable test tenant | No non-production writable environment or test credentials were provided; production is read-only by prompt. | 0ms | safety gate |
...
- PASS: DB-0124 - SELECT 1 - Supabase
- PASS: DB-0125 - expected table exists - usuarios
- PASS: DB-0126 - expected table exists - empresas
- PASS: DB-0127 - expected table exists - usuario_empresa
- PASS: DB-0128 - expected table exists - app_roles
- PASS: DB-0129 - expected table exists - app_permisos
- PASS: DB-0130 - expected table exists - app_usuario_roles
- PASS: DB-0131 - expected table exists - app_usuario_permisos
- PASS: DB-0132 - expected table exists - secuencias_empresa
- PASS: DB-0133 - expected table exists - ventas
- PASS: DB-0134 - expected table exists - detalle_ventas
- PASS: DB-0135 - expected table exists - presupuestos
- PASS: DB-0136 - expected table exists - remitos
- PASS: DB-0137 - expected table exists - detalle_remitos
- PASS: DB-0138 - expected table exists - repartos
- PASS: DB-0139 - expected table exists - reparto_pedidos
- PASS: DB-0140 - expected table exists - clientes
- PASS: DB-0141 - expected table exists - proveedores
- PASS: DB-0142 - expected table exists - customer_fiscal_profile
- PASS: DB-0143 - expected table exists - productos
- PASS: DB-0144 - expected table exists - rubros
- PASS: DB-0145 - expected table exists - margenes
- PASS: DB-0146 - expected table exists - listas_precio
- PASS: DB-0147 - expected table exists - margenes_listas
...
## Multiempresa
- PASS: TENANT-0189 - empresa_id coverage - business tables
...
- PASS: DB-0133 - expected table exists - ventas
- PASS: DB-0134 - expected table exists - detalle_ventas
- PASS: DB-0172 - expected table exists - ventas_modificaciones
...
- PASS: STATIC-0119 - include conexion_starlim_be.php - api/php/stock_upload_be.php
- PASS: DB-0150 - expected table exists - stock_modificaciones
- BLOCKED: E2E-0199 - safe write flow gate - Compra-stock-pago
...
- PASS: DB-0148 - expected table exists - compras_registro
- PASS: DB-0149 - expected table exists - detalle_compras_registro
...
- PASS: STATIC-0015 - include ../php/conexion_starlim_be.php - api/frontend/admin_tesoreria.php
- PASS: PERM-0174 - admin resource exists - admin.tesoreria

## Conciliacion bancaria
- PASS: STATIC-0008 - include ../php/conexion_starlim_be.php - api/frontend/admin_conciliacion_bancaria.php
- PASS: PERM-0175 - admin resource exists - admin.conciliacion_bancaria
- PASS: PROD-0194 - GET route smoke - /frontend/admin_conciliacion_bancaria.php
- BLOCKED: E2E-0200 - safe write flow gate - Conciliacion bancaria write flow

## Facturacion
- PASS: STATIC-0003 - include ../src/Afip.php - api/facturacion/src/afip.php-master/examples/CreateVoucher.php
- PASS: STATIC-0021 - include ../php/conexion_starlim_be.php - api/frontend/facturacion.php
- BLOCKED: E2E-0201 - safe write flow gate - Facturacion fiscal authorization
...
### E2E-0197 - safe write flow gate
- Motivo exacto: No non-production writable environment or test credentials were provided; production is read-only by prompt.
- Variable/credencial/servicio faltante: ver motivo; no se incluyen valores secretos.
- Pruebas afectadas: e2e/business/safe-write-flows
- Como desbloquearlo: proveer entorno local/staging seguro, credenciales de prueba o herramienta faltante.

### E2E-0198 - safe write flow gate
- Motivo exacto: No non-production writable environment or test credentials were provided; production is read-only by prompt.
- Variable/credencial/servicio faltante: ver motivo; no se incluyen valores secretos.
- Pruebas afectadas: e2e/business/safe-write-flows
- Como desbloquearlo: proveer entorno local/staging seguro, credenciales de prueba o herramienta faltante.

### E2E-0199 - safe write flow gate
- Motivo exacto: No non-production writable environment or test credentials were provided; production is read-only by prompt.
- Variable/credencial/servicio faltante: ver motivo; no se incluyen valores secretos.
- Pruebas afectadas: e2e/business/safe-write-flows
- Como desbloquearlo: proveer entorno local/staging seguro, credenciales de prueba o herramienta faltante.

### E2E-0200 - safe write flow gate
- Motivo exacto: No non-production writable environment or test credentials were provided; production is read-only by prompt.
- Variable/credencial/servicio faltante: ver motivo; no se incluyen valores secretos.
- Pruebas afectadas: e2e/business/safe-write-flows
- Como desbloquearlo: proveer entorno local/staging seguro, credenciales de prueba o herramienta faltante.

### E2E-0201 - safe write flow gate
- Motivo exacto: No non-production writable environment or test credentials were provided; production is read-only by prompt.
- Variable/credencial/servicio faltante: ver motivo; no se incluyen valores secretos.
- Pruebas afectadas: e2e/business/safe-write-flows
- Como desbloquearlo: proveer entorno local/staging seguro, credenciales de prueba o herramienta faltante.
...
Rutas cubiertas: 10.42%
Endpoints cubiertos: 0.0%
Reporte: reports/starlim-system-test-20260620-193743.md
========================================
```
