...
export const COMPANY_MANUAL: CompanyManualEntry[] = [
  ...
  },
  {
    ...
    summary: "Los leads usan cadencias automáticas según el resultado; los clientes activos usan ritmo de recompra y las cobranzas usan vencimientos reales.",
    steps: [
      "Registrar o revisar el lead en CRM > Leads.",
      "Registrar el resultado: pedido probable o interesado reaparece en 3 días, contactado sin definición en 7, sin respuesta en 15 y no interesado por ahora en 30.",
      "Aceptar la fecha automática o reemplazarla cuando el cliente haya acordado un día concreto.",
