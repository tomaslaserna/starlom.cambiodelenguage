...
require_once __DIR__ . '/billing_arca_lib.php';

$rango = starlim_normalizar_rango((string)$_SESSION['rango']);
if ($rango !== 'Admin') {
    http_response_code(403);
    echo json_encode(['ok' => false, 'error' => 'Solo Admin puede aprobar y emitir facturas ARCA.']);
    exit;
}
...
$result = billing_authorize_document_arca($conexion, $documentId, (string)$_SESSION['usuario']);
