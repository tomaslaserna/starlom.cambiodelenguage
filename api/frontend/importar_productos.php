...
<head>
    ...
    <title>Importar Productos - Star Lim</title>
...
<body>
    ...
    <main class="import-container">
        ...
        <p class="subtitulo">Cargá un archivo <strong>.CSV</strong> exportado desde Excel para importar productos a la BD <em>starlim</em>.</p>
        ...
        <details open>
            ...
            <table class="tabla-mapeo">
                <thead>
                    <tr><th>#</th><th>Columna en Excel / CSV</th><th>Campo en la BD</th><th>Nota</th></tr>
                </thead>
                <tbody>
                    <tr><td>1</td><td>id_producto</td><td>—</td><td><span class="badge badge-skip">Se ignora (auto-increment)</span></td></tr>
                    <tr><td>2</td><td>rubro</td><td><code>rubro</code></td><td></td></tr>
                    <tr><td>3</td><td>codigo</td><td><code>codigo</code></td><td><span class="badge badge-skip">Código de categoría (no único)</span></td></tr>
                    <tr><td>4</td><td>categoria</td><td><code>categoria</code></td><td></td></tr>
                    <tr><td>5</td><td>proveedor</td><td><code>proveedor</code></td><td></td></tr>
                    <tr><td>6</td><td>nombre</td><td><code>nombre</code></td><td><span class="badge badge-ok">Clave para detectar duplicados</span></td></tr>
                    <tr><td>7</td><td>costo</td><td><code>costo</code></td><td><span class="badge badge-ok">Acepta , o .</span></td></tr>
                    <tr><td>8</td><td>stock</td><td><code>stock</code></td><td></td></tr>
                </tbody>
            </table>
        </details>
    ...
    <script>
        ...
        inputFile.addEventListener('change', function () {
            if (this.files.length > 0) {
                ...
                btnTexto.textContent    = 'Importar productos';
            } else {
        ...
        document.getElementById('formImport').addEventListener('submit', async function (e) {
            ...
            try {
                const resp = await fetch('../php/importar_productos_be.php', { method: 'POST', body: fd });
                ...
                if (data.insertados > 0) {
                    msgExito.textContent   = `Se importaron ${data.insertados} producto(s) correctamente.`;
